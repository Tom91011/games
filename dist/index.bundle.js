...
/* harmony export */ });
/* harmony import */ var _date_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./date-component */ "./src/date-component.js");
...
/* harmony export */ });
/* harmony import */ var _burger_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./burger-component */ "./src/burger-component.js");
/* harmony import */ var _menu_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./menu-component */ "./src/menu-component.js");


function menu() {
  // toggles classes wchih initiates animation effects on the menu
  var menuOuterEl = document.getElementById("menu-outer");
  menuOuterEl.classList.toggle("menu-hidden");
  menuOuterEl.classList.toggle("menu-show");
  var menuOptionsEl = document.querySelector(".menu-options");
  menuOptionsEl.classList.toggle("menu-in");
  menuBtnEl.classList.toggle("menu-btn-in");
  menuBtnEl.classList.toggle("menu-btn-out"); // changes the close button text and arrow direction

  var menuBtnIconEl = document.querySelector("button i");
  menuBtnIconEl.classList.toggle("fa-caret-left");
  menuBtnIconEl.classList.toggle("fa-caret-right");
  menuOut = !menuOut;
  var menuBtnCloseEl = document.querySelector("button h3");
...
var burgerMenu = document.querySelector("burger-component");
...
function populateGrid() {
  var difficultyEl = document.getElementById("selected-difficulty");
  var optionsEl = document.getElementById("options");
  var diffultyOptionsEl = document.querySelectorAll("difficulty-option");
  var gridEl = document.getElementById("grid");
  var gridContainerEl = document.getElementById("game-container-inner");
  ...
  makeGrid(difficultyEl.textContent, gridContainerEl); // returns the index value of the clicked cell in the gridCellArray
  ...
  var resetGame = function resetGame() {
    ...
    function clickBomb(event) {
      ...
      var cellStatus = setCellStatus(bombCell);
    ...
    var startGame = /*#__PURE__*/function () {
      var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
        var cellCategories, cellType, adjCells, adjMines, mines;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return getCellCategories();

              case 3:
                cellCategories = _context.sent;
                _context.next = 6;
                return findCellType(cellCategories, clickedCell);
    ...
    var highlightBomb = function highlightBomb(bombCell, cellStatus) {
      if (cellStatus === "zero" || cellStatus === "number") {} else if (gridCellArray[bombCell].innerHTML === '<i class="fas fa-bomb" <="" i="" aria-hidden="true"></i>') {
    ...
    var updateMinesHeading = function updateMinesHeading() {
      var mineCellArray = document.querySelectorAll(".bomb");
      var minesToFoundEl = document.getElementById("bombs-to-find");
...
var gridCellArray = document.querySelectorAll(".cell");
var gameOverEl = document.getElementById("game-over");
var youWonMessageEl = document.getElementById("won");
var youLoseMessageEl = document.getElementById("lose");
var gridTypes = [{
  difficulty: "Easy",
  width: 12,
  height: 10,
...
var setCellStatus = function setCellStatus(cell) {
...
var layMines = function layMines(cellType, clickedCell) {
  var adjCells = findAdjCells(cellType, clickedCell);

  while (minesArray.length < totalMines) {
    var randomNumber = getRandomNumber();

    if (minesArray.includes(randomNumber) !== true && randomNumber !== clickedCell && adjCells.includes(randomNumber) !== true) {
...
var getCellCategories = function getCellCategories() {
  ...
  var bottomLeftCell = bottomRightCell - gridWidth + 1;
  var topRowArray = topRowCells(gridWidth);
  var leftColumnArray = leftRowCells(gridWidth, bottomLeftCell);
  var rightColumnArray = rightRowCells(gridWidth, bottomRightCell);
  var bottomRowArray = bottomRowCells(gridWidth, bottomRightCell);
  var gridCellArray = document.querySelectorAll(".cell");
  var cellCatorgories = {
    tl: topLeftCell,
    tr: topRightCell,
...
var revealMines = function revealMines() {
  var gridCellArray = document.querySelectorAll(".cell");
  minesArray.forEach(function (element, i) {
    setTimeout(function () {
...
var checkMoreZeroes = function checkMoreZeroes(item, initialZeroArrayLength) {
  var gridCellArray = document.querySelectorAll(".cell");
  var cellType = findCellType(getCellCategories(), item);
  var adjCellsArray = findAdjCells(cellType, item);
  var startIterationOfArray = checkForNeighbouringZerosIteration(adjCellsArray);
};

var alternateCellColour = function alternateCellColour(cell, array) {
  if (Math.floor(cell / gridWidth) % 2 && cell % 2 == 0) {
...
var checkForNeighbouringZero = function checkForNeighbouringZero(item, initialZeroArrayLength) {
  ...
  var cellType = findCellType(getCellCategories(), item);
  var adjCellsArray = findAdjCells(cellType, item);
  var neighbouringMinesArray = checkForNeighbouringMines(adjCellsArray);
...
var hasWon = function hasWon() {
  var allChecked = 0;
  var correctMines = 0;
  numberStatusList.forEach(function (element) {
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/montserrat-v18-latin-300.woff2 */ "./src/fonts/montserrat-v18-latin-300.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/montserrat-v18-latin-300.woff */ "./src/fonts/montserrat-v18-latin-300.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/montserrat-v18-latin-regular.woff2 */ "./src/fonts/montserrat-v18-latin-regular.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/montserrat-v18-latin-600.woff2 */ "./src/fonts/montserrat-v18-latin-600.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/montserrat-v18-latin-600.woff */ "./src/fonts/montserrat-v18-latin-600.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_5___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/architects-daughter-v11-latin-regular.woff2 */ "./src/fonts/architects-daughter-v11-latin-regular.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_6___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/architects-daughter-v11-latin-regular.woff */ "./src/fonts/architects-daughter-v11-latin-regular.woff"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_7___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/cards-icon.png */ "./src/imgs/cards-icon.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_8___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/dice-icon.png */ "./src/imgs/dice-icon.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_9___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/bomb-icon.png */ "./src/imgs/bomb-icon.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_10___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/pacman-icon.png */ "./src/imgs/pacman-icon.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_11___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/dominoes-icon.png */ "./src/imgs/dominoes-icon.png"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_12___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/rps-icon.png */ "./src/imgs/rps-icon.png"), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* montserrat-300 - latin */\n@font-face {\n  font-family: \"Montserrat-300\";\n  font-style: normal;\n  font-weight: 300;\n  src: local(\"\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* montserrat-regular - latin */\n@font-face {\n  font-family: \"Montserrat-400\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* montserrat-600 - latin */\n@font-face {\n  font-family: \"Montserrat-600\";\n  font-style: normal;\n  font-weight: 600;\n  src: local(\"\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* architects-daughter-regular - latin */\n@font-face {\n  font-family: \"Architects Daughter\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ") format(\"woff2\"), url(" + ___CSS_LOADER_URL_REPLACEMENT_6___ + ") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\nhtml, body {\n  margin: 0;\n  color: #222831;\n  background-color: #393e46;\n  position: relative;\n  height: 100%;\n  width: 100%;\n  overflow: hidden;\n  font-family: Montserrat-300, sans-serif;\n  font-size: 16px;\n}\n\nfooter {\n  position: absolute;\n  bottom: 20px;\n  width: 100%;\n  text-align: center;\n}\n\nnav {\n  width: 100%;\n}\n\nh1 {\n  font-size: 2em;\n}\n\nh3, h1 {\n  overflow: hidden;\n  white-space: nowrap;\n}\n\ni {\n  padding: 10px;\n  font-size: 1.5em;\n}\n\nli {\n  list-style: none;\n  line-height: 1.5;\n  white-space: nowrap;\n}\n\na {\n  text-decoration: none;\n  color: #222831;\n}\n\na:hover {\n  color: #dbe8d4;\n  background-color: #393e46;\n}\n\n#menu-outer {\n  background-color: #00adb5;\n  padding: 0;\n}\n#menu-outer date-component {\n  height: 50px;\n  background-color: #222831;\n}\n#menu-outer #date-container {\n  padding: 10px 0;\n  background-color: #222831;\n  color: #00adb5;\n  width: 100%;\n  height: 100%;\n  background-color: #222831;\n}\n#menu-outer #date-container #date, #menu-outer #date-container #time {\n  padding-left: 10px;\n}\n#menu-outer #menu {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  align-items: flex-start;\n}\n#menu-outer #menu .menu-options {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  background-color: #00adb5;\n  overflow: hidden;\n  flex-wrap: nowrap;\n  height: 100vh;\n}\n#menu-outer #menu .hide-btn {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 240px;\n}\n#menu-outer #menu #menu-btn {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  width: 100%;\n}\n@keyframes menu-btn-in {\n  from {\n    width: 240px;\n  }\n  to {\n    width: 40px;\n  }\n  from {\n    padding: 0 50px;\n  }\n  to {\n    padding: 0 0;\n  }\n}\n@keyframes menu-btn-out {\n  from {\n    width: 40px;\n  }\n  to {\n    width: 240px;\n  }\n  from {\n    padding: 0 0;\n  }\n  to {\n    padding: 0 50px;\n  }\n}\n#menu-outer #menu .menu-btn-in {\n  animation-name: menu-btn-in;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer #menu .menu-btn-out {\n  animation-name: menu-btn-out;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer h1 {\n  margin: 10px 0 5px 0;\n}\n#menu-outer ul {\n  margin: 0;\n  padding-left: 0;\n  width: 100%;\n}\n#menu-outer ul a {\n  padding-left: 15px;\n  display: inline-block;\n  width: 100%;\n}\n@keyframes menu-inn {\n  from {\n    width: 180px;\n  }\n  to {\n    width: 0;\n  }\n  from {\n    padding: 0 10px;\n  }\n  to {\n    padding: 0 0;\n  }\n}\n@keyframes menu-outt {\n  from {\n    width: 0;\n  }\n  to {\n    width: 180px;\n  }\n  from {\n    padding: 0 0;\n  }\n  to {\n    padding: 0 10px;\n  }\n}\n#menu-outer .menu-out {\n  animation-name: menu-outt;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer .menu-in {\n  animation-name: menu-inn;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n\n@keyframes menu-hide {\n  from {\n    width: 240px;\n  }\n  to {\n    width: 40px;\n  }\n}\n.menu-hidden {\n  animation-name: menu-hide;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  justify-content: flex-end;\n}\n\n@keyframes menu-show {\n  from {\n    width: 40px;\n  }\n  to {\n    width: 240px;\n  }\n}\n.menu-show {\n  animation-name: menu-show;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  justify-content: flex-end;\n}\n\nburger-component {\n  width: 40px;\n  height: 100vh;\n  background-color: #222831 !important;\n}\n\ni {\n  color: #dbe8d4;\n  border: none;\n}\ni:hover {\n  cursor: pointer;\n  color: #00adb5;\n}\n\n#burger-menu {\n  width: auto;\n}\n\n@keyframes burger-show {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 100%;\n  }\n  from {\n    width: 0;\n  }\n  to {\n    width: 40px;\n  }\n}\n.burger-menu-show {\n  animation-name: burger-show;\n  animation-duration: 0.2s;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  align-items: flex-start;\n  height: 100vh;\n  background-color: #222831;\n}\n\n@keyframes burger-hide {\n  from {\n    opacity: 100%;\n  }\n  to {\n    opacity: 0;\n  }\n}\n.burger-menu-hidden {\n  animation-name: burger-hide;\n  animation-fill-mode: forwards;\n}\n\n@keyframes opacity {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 100%;\n  }\n}\ni {\n  animation-name: opacity;\n  animation-duration: 1s;\n}\n\n.container {\n  display: flex;\n  flex-direction: row;\n  justify-content: centre;\n  align-items: center;\n}\n\n.game-grid {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  position: relative;\n  top: -60px;\n  flex-wrap: wrap;\n  margin: auto;\n  width: 1200px;\n}\n.game-grid .game-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: centre;\n  align-items: center;\n  margin: 20px;\n  height: 300px;\n  width: 300px;\n}\n.game-grid .game-container:hover {\n  cursor: pointer;\n}\n.game-grid .game-container .game-picture {\n  height: 300px;\n  width: 300px;\n}\n\n#cards {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_7___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#dice {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_8___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#minesweeper {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_9___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#pacman {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_10___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#dominoes {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_11___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#rps {\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_12___ + ");\n  background-repeat: no-repeat;\n  background-size: 300px;\n  border-radius: 150px;\n}\n\nbutton {\n  padding: 0;\n  right: 24px;\n  color: #dbe8d4;\n  background-color: #222831;\n  border: none;\n}\nbutton:hover {\n  cursor: pointer;\n  color: #00adb5;\n}\n\n#game-container-outer {\n  position: relative;\n  top: -60px;\n  margin: 0 auto;\n  width: 1200px;\n  align-self: center;\n}\n#game-container-outer #title {\n  position: relative;\n  margin: 0 auto;\n  color: #00adb5;\n  font-size: 3em;\n  text-align: center;\n  letter-spacing: 0.1em;\n}\n#game-container-outer .small {\n  width: 300px;\n}\n#game-container-outer .medium {\n  width: 450px;\n}\n#game-container-outer .large {\n  width: 600px;\n}\n#game-container-outer #game-container-inner {\n  position: relative;\n  margin: 0 auto;\n}\n#game-container-outer #game-container-inner #stats-row {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: 50px;\n  background-color: #222831;\n  color: #dbe8d4;\n}\n#game-container-outer #game-container-inner #stats-row #bombs {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: center;\n  width: 30%;\n}\n#game-container-outer #game-container-inner #stats-row #bombs i:hover {\n  color: #dbe8d4;\n  cursor: default;\n}\n#game-container-outer #game-container-inner #stats-row #difficulty {\n  position: relative;\n  margin: 0 0 auto 10px;\n  padding-right: 10px;\n  width: 30%;\n  font-size: 0.8em;\n  background-color: #222831;\n  text-align: right;\n}\n#game-container-outer #game-container-inner #stats-row #difficulty #selected-difficulty {\n  margin: 11px 0 0 0;\n}\n#game-container-outer #game-container-inner #stats-row #options {\n  padding: 20px 0 10px 0;\n  font-size: 0.9em;\n}\n#game-container-outer #game-container-inner #stats-row #options h2 {\n  margin: auto 0;\n  padding-bottom: 5px;\n}\n#game-container-outer #game-container-inner #stats-row #options h2:hover {\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #stats-row .hidden {\n  visibility: hidden;\n  display: none;\n}\n#game-container-outer #game-container-inner #grid {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: center;\n  align-items: flex-start;\n  flex-wrap: wrap;\n  width: 100%;\n  height: 100%;\n  z-index: 0;\n}\n#game-container-outer #game-container-inner #grid .cell {\n  width: 25px;\n  height: 25px;\n  box-sizing: border-box;\n  padding-top: 2px;\n  color: #393e46;\n  font-family: Architects-Daughter-400, montserrat-600, sans-serif;\n  text-align: center;\n}\n#game-container-outer #game-container-inner #grid .light-cell {\n  background-color: #415F82;\n}\n#game-container-outer #game-container-inner #grid .light-cell:hover {\n  cursor: pointer;\n  filter: brightness(120%);\n}\n#game-container-outer #game-container-inner #grid .dark-cell {\n  background-color: #465881;\n}\n#game-container-outer #game-container-inner #grid .dark-cell:hover {\n  cursor: pointer;\n  filter: brightness(95%);\n}\n#game-container-outer #game-container-inner #grid .safe-light {\n  background-color: #B7E778;\n}\n#game-container-outer #game-container-inner #grid .safe-dark {\n  background-color: #A1DD70;\n}\n#game-container-outer #game-container-inner #grid .bomb {\n  background-color: #222831;\n  padding: 0;\n}\n#game-container-outer #game-container-inner #grid .bomb .fa-bomb {\n  color: #ff9300 !important;\n  padding: 0 0 0 1px;\n  width: 90%;\n}\n#game-container-outer #game-container-inner #grid .bomb-explode {\n  background-color: #222831;\n  padding: 0;\n}\n#game-container-outer #game-container-inner #grid .bomb-explode .fa-bomb {\n  background-color: #222831;\n  padding: 0;\n  color: red;\n}\n#game-container-outer #game-container-inner #game-over {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  height: auto;\n  width: 50%;\n  transform: translate(-50%, -50%);\n  color: #dbe8d4;\n  background-color: #222831;\n  opacity: 90%;\n  text-align: center;\n}\n#game-container-outer #game-container-inner #game-over #start-again {\n  display: flex;\n  flex-direction: row;\n  justify-content: centre;\n  align-items: center;\n  background-color: #222831;\n  width: 100%;\n  height: 50px;\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #game-over #start-again button {\n  width: 100%;\n  font-size: 1.1em;\n  font-family: montserrat-600;\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #game-over #start-again button:hover {\n  color: #393e46;\n}\n#game-container-outer #game-container-inner .hidden {\n  visibility: hidden;\n  display: none;\n  font-size: 100px;\n}", "",{"version":3,"sources":["webpack://./src/scss/_abstracts.scss","webpack://./src/scss/main.scss","webpack://./src/scss/_base.scss","webpack://./src/scss/layout/_menu.scss","webpack://./src/scss/layout/_main.scss","webpack://./src/scss/_components.scss","webpack://./src/scss/pages/_minesweeper.scss"],"names":[],"mappings":"AAqBA,2BAAA;AACA;EACE,6BAAA;EACA,kBAAA;EACA,gBAAA;EACA,+HAAA;EAEmE,gDAAA;ACrBrE;ADuBA,+BAAA;AACA;EACE,6BAAA;EACA,kBAAA;EACA,gBAAA;EACA,+HAAA;EAEwE,gDAAA;ACtB1E;ADwBA,2BAAA;AACA;EACE,6BAAA;EACA,kBAAA;EACA,gBAAA;EACA,+HAAA;EAEmE,gDAAA;ACvBrE;ADyBA,wCAAA;AACA;EACE,kCAAA;EACA,kBAAA;EACA,gBAAA;EACA,+HAAA;EAEgF,gDAAA;ACxBlF;AC/BA;EACE,SAAA;EACA,cFFkB;EEGlB,yBFFiB;EEGjB,kBAAA;EACA,YAAA;EACA,WAAA;EACA,gBAAA;EACA,uCAAA;EACA,eAAA;ADiCF;;AC9BA;EACE,kBAAA;EACA,YAAA;EACA,WAAA;EACA,kBAAA;ADiCF;;AC9BA;EACE,WAAA;ADiCF;;AC9BA;EACE,cAAA;ADiCF;;AC9BA;EACE,gBAAA;EACA,mBAAA;ADiCF;;AC7BA;EACE,aAAA;EACA,gBAAA;ADgCF;;AC7BA;EACE,gBAAA;EACA,gBAAA;EACA,mBAAA;ADgCF;;AC7BA;EACE,qBAAA;EACA,cF9CkB;AC8EpB;;AC/BE;EACE,cF5CgB;EE6ChB,yBFhDe;ACkFnB;;AEnFA;EACE,yBHCmB;EGAnB,UAAA;AFsFF;AErFE;EACE,YAAA;EACA,yBHLgB;AC4FpB;AErFE;EACE,eAAA;EACA,yBHTgB;EGUhB,cHRiB;EGSjB,WAAA;EACA,YAAA;EACA,yBHbgB;ACoGpB;AEtFI;EACA,kBAAA;AFwFJ;AEtFI;EHHF,aAAA;EACA,mBGGsB;EHFtB,8BGE2B;EHD3B,mBAAA;EGEI,uBAAA;AF2FN;AE1FM;EHNJ,aAAA;EACA,sBGMwB;EHLxB,8BGKgC;EHJhC,mBAAA;EGKM,yBHpBa;EGqBb,gBAAA;EACA,iBAAA;EACA,aAAA;AF+FR;AE9FQ;EACE,kBAAA;EACA,SAAA;EACA,OAAA;EACA,YAAA;AFgGV;AE/FU;EHjBR,aAAA;EACA,mBGiB0B;EHhB1B,6BGgB+B;EHf/B,mBAAA;EGkBQ,WAAA;AFkGV;AEjGU;EACA;IAAM,YAAA;EFoGd;EEnGQ;IAAI,WAAA;EFsGZ;EErGU;IAAM,eAAA;EFwGhB;EEvGU;IAAI,YAAA;EF0Gd;AACF;AE1GU;EACA;IAAM,WAAA;EF6Gd;EE5GQ;IAAI,YAAA;EF+GZ;EE9GQ;IAAM,YAAA;EFiHd;EEhHQ;IAAI,eAAA;EFmHZ;AACF;AEnHU;EACE,2BAAA;EACA,sBAAA;EACA,6BAAA;AFqHZ;AEpHU;EACE,4BAAA;EACA,sBAAA;EACA,6BAAA;AFsHZ;AEnHI;EACE,oBAAA;AFqHN;AEnHI;EACE,SAAA;EACA,eAAA;EACA,WAAA;AFqHN;AEpHI;EACE,kBAAA;EACA,qBAAA;EACA,WAAA;AFsHN;AEnHE;EACE;IAAM,YAAA;EFsHR;EErHE;IAAI,QAAA;EFwHN;EEvHE;IAAM,eAAA;EF0HR;EEzHE;IAAI,YAAA;EF4HN;AACF;AE3HE;EACE;IAAM,QAAA;EF8HR;EE7HE;IAAI,YAAA;EFgIN;EE/HE;IAAM,YAAA;EFkIR;EEjIE;IAAI,eAAA;EFoIN;AACF;AEnIE;EACE,yBAAA;EACA,sBAAA;EACA,6BAAA;AFqIJ;AEnIE;EACE,wBAAA;EACA,sBAAA;EACA,6BAAA;AFqIJ;;AEhIA;EACE;IAAM,YAAA;EFoIN;EEnIA;IAAI,WAAA;EFsIJ;AACF;AEpIA;EACE,yBAAA;EACA,sBAAA;EACA,6BAAA;EACA,yBAAA;AFsIF;;AEnIA;EACE;IAAM,WAAA;EFuIN;EEtIA;IAAI,YAAA;EFyIJ;AACF;AEvIA;EACE,yBAAA;EACA,sBAAA;EACA,6BAAA;EACA,yBAAA;AFyIF;;AErIA;EACE,WAAA;EACA,aAAA;EACA,oCAAA;AFwIF;;AEvIE;EACA,cHxHkB;EGyHlB,YAAA;AF0IF;AEzII;EACE,eAAA;EACA,cH9He;ACyQrB;;AExIE;EACA,WAAA;AF2IF;;AExIA;EACE;IAAM,UAAA;EF4IN;EE3IA;IAAI,aAAA;EF8IJ;EE7IA;IAAM,QAAA;EFgJN;EE/IA;IAAI,WAAA;EFkJJ;AACF;AEhJA;EACE,2BAAA;EACA,wBAAA;EHlIA,aAAA;EACA,mBGkIkB;EHjIlB,8BGiIuB;EHhIvB,mBAAA;EGiIA,uBAAA;EACA,aAAA;EACA,yBHpJkB;ACySpB;;AEjJA;EACE;IAAM,aAAA;EFqJN;EEpJA;IAAI,UAAA;EFuJJ;AACF;AErJA;EACE,2BAAA;EACA,6BAAA;AFuJF;;AEpJA;EACE;IAAM,UAAA;EFwJN;EEvJA;IAAI,aAAA;EF0JJ;AACF;AExJA;EACE,uBAAA;EACA,sBAAA;AF0JF;;AGnUA;EJcE,aAAA;EACA,mBIdkB;EJelB,uBIfuB;EJgBvB,mBAAA;ACyTF;;AGtUA;EJUE,aAAA;EACA,mBIVkB;EJWlB,6BIXuB;EJYvB,mBAAA;EIXA,kBAAA;EACA,UAAA;EACA,eAAA;EACA,YAAA;EACA,aAAA;AH4UF;AG3UE;EJGA,aAAA;EACA,sBIHoB;EJIpB,uBIJ4B;EJK5B,mBAAA;EIJE,YAAA;EACA,aAAA;EACA,YAAA;AHgVJ;AG/UI;EACE,eAAA;AHiVN;AG/UI;EACE,aAAA;EACA,YAAA;AHiVN;;AG5UA;EACE,mDAAA;EACA,4BAAA;EACA,sBAAA;AH+UF;;AG7UA;EACE,mDAAA;EACA,4BAAA;EACA,sBAAA;AHgVF;;AG9UA;EACE,mDAAA;EACA,4BAAA;EACA,sBAAA;AHiVF;;AG/UA;EACE,oDAAA;EACA,4BAAA;EACA,sBAAA;AHkVF;;AGhVA;EACE,oDAAA;EACA,4BAAA;EACA,sBAAA;AHmVF;;AGjVA;EACE,oDAAA;EACA,4BAAA;EACA,sBAAA;EACA,oBAAA;AHoVF;;AI3YA;EACE,UAAA;EACA,WAAA;EACA,cLCkB;EKAlB,yBLJkB;EKKlB,YAAA;AJ8YF;AI7YI;EACE,eAAA;EAEA,cLPe;ACqZrB;;AKrZA;EACE,kBAAA;EACA,UAAA;EACA,cAAA;EACA,aAAA;EACA,kBAAA;ALwZF;AKvZE;EACE,kBAAA;EACA,cAAA;EACA,cNTiB;EMUjB,cAAA;EACA,kBAAA;EACA,qBAAA;ALyZJ;AKvZE;EACE,YAAA;ALyZJ;AKvZE;EACE,YAAA;ALyZJ;AKvZE;EACE,YAAA;ALyZJ;AKvZE;EACE,kBAAA;EACA,cAAA;ALyZJ;AKvZI;ENfF,aAAA;EACA,mBMewB;ENdxB,8BMc6B;ENb7B,mBAAA;EMcM,WAAA;EACA,YAAA;EACA,yBNjCY;EMkCZ,cN9BY;AC0bpB;AK1ZQ;ENtBN,aAAA;EACA,mBMsB0B;ENrB1B,2BMqB+B;ENpB/B,mBAAA;EMqBQ,UAAA;AL+ZV;AK9ZW;EACC,cNpCQ;EMqCR,eAAA;ALgaZ;AK7ZQ;EACE,kBAAA;EACA,qBAAA;EACA,mBAAA;EACA,UAAA;EACA,gBAAA;EACA,yBNlDU;EMmDV,iBAAA;AL+ZV;AK9ZU;EACE,kBAAA;ALgaZ;AK7ZQ;EACE,sBAAA;EACA,gBAAA;AL+ZV;AK9ZU;EACE,cAAA;EACA,mBAAA;ALgaZ;AK/ZY;EACE,yBN7DO;AC8drB;AK9ZU;EACE,kBAAA;EACA,aAAA;ALgaZ;AK7ZI;ENzDF,aAAA;EACA,mBMyDsB;ENxDtB,2BMwD2B;ENvD3B,mBAAA;EMwDI,uBAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;EAEA,UAAA;ALiaN;AKhaM;EACE,WAAA;EACA,YAAA;EACA,sBAAA;EACA,gBAAA;EACA,cNnFW;EMoFX,gEN1EU;EM2EV,kBAAA;ALkaR;AK/ZM;EACE,yBAAA;ALiaR;AKhaQ;EACE,eAAA;EACA,wBAAA;ALkaV;AK/ZM;EACI,yBAAA;ALiaV;AKhaU;EACE,eAAA;EACA,uBAAA;ALkaZ;AK/ZM;EACE,yBNnGiB;ACogBzB;AK/ZM;EACE,yBNrGgB;ACsgBxB;AK/ZM;EACE,yBN9GY;EM+GZ,UAAA;ALiaR;AKhaQ;EACE,yBAAA;EACA,kBAAA;EACA,UAAA;ALkaV;AK/ZM;EACE,yBNvHY;EMwHZ,UAAA;ALiaR;AKhaQ;EACE,yBN1HU;EM2HV,UAAA;EACA,UAAA;ALkaV;AK9ZI;EACE,kBAAA;EACA,QAAA;EACA,SAAA;EACA,YAAA;EACA,UAAA;EACA,gCAAA;EACA,cNnIc;EMoId,yBNxIc;EMyId,YAAA;EACA,kBAAA;ALgaN;AK3ZM;ENjIJ,aAAA;EACA,mBMiIwB;ENhIxB,uBMgI6B;EN/H7B,mBAAA;EMgIM,yBNjJY;EMkJZ,WAAA;EACA,YAAA;EACA,yBNlJa;ACkjBrB;AK/ZQ;EACE,WAAA;EACA,gBAAA;EACA,2BAAA;EACA,yBNvJW;ACwjBrB;AKhaU;EACA,cN1JS;AC4jBnB;AK/ZM;EACE,kBAAA;EACA,aAAA;EACA,gBAAA;ALiaR","sourcesContent":["$primaryColorBlack: rgb(34, 40, 49);\r\n$primaryColorGrey: rgb(57, 62, 70);\r\n$primaryColorOrange: rgb(0,173,181);\r\n$primaryColorLightOrange: rgb(255,147,0);\r\n$primaryColorWhite: rgb(219,232,212);\r\n$primaryColorlightGreen: #B7E778;\r\n$primaryColorDarkGreen: #A1DD70;\r\n\r\n$fontMainLight: Montserrat-300, sans-serif;\r\n$fontMainRegular: Montserrat-400, sans-serif;\r\n$fontMainHeavy: Montserrat-600, sans-serif;\r\n$minesweeperGrid: Architects-Daughter-400, montserrat-600, sans-serif;\r\n\r\n@mixin flex-row($direction, $justifyContent) {\r\n  display: flex;\r\n  flex-direction: $direction;\r\n  justify-content: $justifyContent;\r\n  align-items: center;\r\n}\r\n\r\n\r\n/* montserrat-300 - latin */\r\n@font-face {\r\n  font-family: 'Montserrat-300';\r\n  font-style: normal;\r\n  font-weight: 300;\r\n  src: local(''),\r\n       url('../fonts/montserrat-v18-latin-300.woff2') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */\r\n       url('../fonts/montserrat-v18-latin-300.woff') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\r\n}\r\n/* montserrat-regular - latin */\r\n@font-face {\r\n  font-family: 'Montserrat-400';\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  src: local(''),\r\n       url('../fonts/montserrat-v18-latin-regular.woff2') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */\r\n       url('../fonts/montserrat-v18-latin-regular.woff2') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\r\n}\r\n/* montserrat-600 - latin */\r\n@font-face {\r\n  font-family: 'Montserrat-600';\r\n  font-style: normal;\r\n  font-weight: 600;\r\n  src: local(''),\r\n       url('../fonts/montserrat-v18-latin-600.woff2') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */\r\n       url('../fonts/montserrat-v18-latin-600.woff') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\r\n}\r\n/* architects-daughter-regular - latin */\r\n@font-face {\r\n  font-family: 'Architects Daughter';\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  src: local(''),\r\n       url('../fonts/architects-daughter-v11-latin-regular.woff2') format('woff2'), /* Chrome 26+, Opera 23+, Firefox 39+ */\r\n       url('../fonts/architects-daughter-v11-latin-regular.woff') format('woff'); /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\r\n}\r\n","/* montserrat-300 - latin */\n@font-face {\n  font-family: \"Montserrat-300\";\n  font-style: normal;\n  font-weight: 300;\n  src: local(\"\"), url(\"../fonts/montserrat-v18-latin-300.woff2\") format(\"woff2\"), url(\"../fonts/montserrat-v18-latin-300.woff\") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* montserrat-regular - latin */\n@font-face {\n  font-family: \"Montserrat-400\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"\"), url(\"../fonts/montserrat-v18-latin-regular.woff2\") format(\"woff2\"), url(\"../fonts/montserrat-v18-latin-regular.woff2\") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* montserrat-600 - latin */\n@font-face {\n  font-family: \"Montserrat-600\";\n  font-style: normal;\n  font-weight: 600;\n  src: local(\"\"), url(\"../fonts/montserrat-v18-latin-600.woff2\") format(\"woff2\"), url(\"../fonts/montserrat-v18-latin-600.woff\") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\n/* architects-daughter-regular - latin */\n@font-face {\n  font-family: \"Architects Daughter\";\n  font-style: normal;\n  font-weight: 400;\n  src: local(\"\"), url(\"../fonts/architects-daughter-v11-latin-regular.woff2\") format(\"woff2\"), url(\"../fonts/architects-daughter-v11-latin-regular.woff\") format(\"woff\");\n  /* Chrome 6+, Firefox 3.6+, IE 9+, Safari 5.1+ */\n}\nhtml, body {\n  margin: 0;\n  color: #222831;\n  background-color: #393e46;\n  position: relative;\n  height: 100%;\n  width: 100%;\n  overflow: hidden;\n  font-family: Montserrat-300, sans-serif;\n  font-size: 16px;\n}\n\nfooter {\n  position: absolute;\n  bottom: 20px;\n  width: 100%;\n  text-align: center;\n}\n\nnav {\n  width: 100%;\n}\n\nh1 {\n  font-size: 2em;\n}\n\nh3, h1 {\n  overflow: hidden;\n  white-space: nowrap;\n}\n\ni {\n  padding: 10px;\n  font-size: 1.5em;\n}\n\nli {\n  list-style: none;\n  line-height: 1.5;\n  white-space: nowrap;\n}\n\na {\n  text-decoration: none;\n  color: #222831;\n}\n\na:hover {\n  color: #dbe8d4;\n  background-color: #393e46;\n}\n\n#menu-outer {\n  background-color: #00adb5;\n  padding: 0;\n}\n#menu-outer date-component {\n  height: 50px;\n  background-color: #222831;\n}\n#menu-outer #date-container {\n  padding: 10px 0;\n  background-color: #222831;\n  color: #00adb5;\n  width: 100%;\n  height: 100%;\n  background-color: #222831;\n}\n#menu-outer #date-container #date, #menu-outer #date-container #time {\n  padding-left: 10px;\n}\n#menu-outer #menu {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  align-items: flex-start;\n}\n#menu-outer #menu .menu-options {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  background-color: #00adb5;\n  overflow: hidden;\n  flex-wrap: nowrap;\n  height: 100vh;\n}\n#menu-outer #menu .hide-btn {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 240px;\n}\n#menu-outer #menu #menu-btn {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  width: 100%;\n}\n@keyframes menu-btn-in {\n  from {\n    width: 240px;\n  }\n  to {\n    width: 40px;\n  }\n  from {\n    padding: 0 50px;\n  }\n  to {\n    padding: 0 0;\n  }\n}\n@keyframes menu-btn-out {\n  from {\n    width: 40px;\n  }\n  to {\n    width: 240px;\n  }\n  from {\n    padding: 0 0;\n  }\n  to {\n    padding: 0 50px;\n  }\n}\n#menu-outer #menu .menu-btn-in {\n  animation-name: menu-btn-in;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer #menu .menu-btn-out {\n  animation-name: menu-btn-out;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer h1 {\n  margin: 10px 0 5px 0;\n}\n#menu-outer ul {\n  margin: 0;\n  padding-left: 0;\n  width: 100%;\n}\n#menu-outer ul a {\n  padding-left: 15px;\n  display: inline-block;\n  width: 100%;\n}\n@keyframes menu-inn {\n  from {\n    width: 180px;\n  }\n  to {\n    width: 0;\n  }\n  from {\n    padding: 0 10px;\n  }\n  to {\n    padding: 0 0;\n  }\n}\n@keyframes menu-outt {\n  from {\n    width: 0;\n  }\n  to {\n    width: 180px;\n  }\n  from {\n    padding: 0 0;\n  }\n  to {\n    padding: 0 10px;\n  }\n}\n#menu-outer .menu-out {\n  animation-name: menu-outt;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n#menu-outer .menu-in {\n  animation-name: menu-inn;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n}\n\n@keyframes menu-hide {\n  from {\n    width: 240px;\n  }\n  to {\n    width: 40px;\n  }\n}\n.menu-hidden {\n  animation-name: menu-hide;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  justify-content: flex-end;\n}\n\n@keyframes menu-show {\n  from {\n    width: 40px;\n  }\n  to {\n    width: 240px;\n  }\n}\n.menu-show {\n  animation-name: menu-show;\n  animation-duration: 1s;\n  animation-fill-mode: forwards;\n  justify-content: flex-end;\n}\n\nburger-component {\n  width: 40px;\n  height: 100vh;\n  background-color: #222831 !important;\n}\n\ni {\n  color: #dbe8d4;\n  border: none;\n}\ni:hover {\n  cursor: pointer;\n  color: #00adb5;\n}\n\n#burger-menu {\n  width: auto;\n}\n\n@keyframes burger-show {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 100%;\n  }\n  from {\n    width: 0;\n  }\n  to {\n    width: 40px;\n  }\n}\n.burger-menu-show {\n  animation-name: burger-show;\n  animation-duration: 0.2s;\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  align-items: flex-start;\n  height: 100vh;\n  background-color: #222831;\n}\n\n@keyframes burger-hide {\n  from {\n    opacity: 100%;\n  }\n  to {\n    opacity: 0;\n  }\n}\n.burger-menu-hidden {\n  animation-name: burger-hide;\n  animation-fill-mode: forwards;\n}\n\n@keyframes opacity {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 100%;\n  }\n}\ni {\n  animation-name: opacity;\n  animation-duration: 1s;\n}\n\n.container {\n  display: flex;\n  flex-direction: row;\n  justify-content: centre;\n  align-items: center;\n}\n\n.game-grid {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  align-items: center;\n  position: relative;\n  top: -60px;\n  flex-wrap: wrap;\n  margin: auto;\n  width: 1200px;\n}\n.game-grid .game-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: centre;\n  align-items: center;\n  margin: 20px;\n  height: 300px;\n  width: 300px;\n}\n.game-grid .game-container:hover {\n  cursor: pointer;\n}\n.game-grid .game-container .game-picture {\n  height: 300px;\n  width: 300px;\n}\n\n#cards {\n  background: url(\"../imgs/cards-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#dice {\n  background: url(\"../imgs/dice-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#minesweeper {\n  background: url(\"../imgs/bomb-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#pacman {\n  background: url(\"../imgs/pacman-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#dominoes {\n  background: url(\"../imgs/dominoes-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n}\n\n#rps {\n  background: url(\"../imgs/rps-icon.png\");\n  background-repeat: no-repeat;\n  background-size: 300px;\n  border-radius: 150px;\n}\n\nbutton {\n  padding: 0;\n  right: 24px;\n  color: #dbe8d4;\n  background-color: #222831;\n  border: none;\n}\nbutton:hover {\n  cursor: pointer;\n  color: #00adb5;\n}\n\n#game-container-outer {\n  position: relative;\n  top: -60px;\n  margin: 0 auto;\n  width: 1200px;\n  align-self: center;\n}\n#game-container-outer #title {\n  position: relative;\n  margin: 0 auto;\n  color: #00adb5;\n  font-size: 3em;\n  text-align: center;\n  letter-spacing: 0.1em;\n}\n#game-container-outer .small {\n  width: 300px;\n}\n#game-container-outer .medium {\n  width: 450px;\n}\n#game-container-outer .large {\n  width: 600px;\n}\n#game-container-outer #game-container-inner {\n  position: relative;\n  margin: 0 auto;\n}\n#game-container-outer #game-container-inner #stats-row {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n  height: 50px;\n  background-color: #222831;\n  color: #dbe8d4;\n}\n#game-container-outer #game-container-inner #stats-row #bombs {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: center;\n  width: 30%;\n}\n#game-container-outer #game-container-inner #stats-row #bombs i:hover {\n  color: #dbe8d4;\n  cursor: default;\n}\n#game-container-outer #game-container-inner #stats-row #difficulty {\n  position: relative;\n  margin: 0 0 auto 10px;\n  padding-right: 10px;\n  width: 30%;\n  font-size: 0.8em;\n  background-color: #222831;\n  text-align: right;\n}\n#game-container-outer #game-container-inner #stats-row #difficulty #selected-difficulty {\n  margin: 11px 0 0 0;\n}\n#game-container-outer #game-container-inner #stats-row #options {\n  padding: 20px 0 10px 0;\n  font-size: 0.9em;\n}\n#game-container-outer #game-container-inner #stats-row #options h2 {\n  margin: auto 0;\n  padding-bottom: 5px;\n}\n#game-container-outer #game-container-inner #stats-row #options h2:hover {\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #stats-row .hidden {\n  visibility: hidden;\n  display: none;\n}\n#game-container-outer #game-container-inner #grid {\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: center;\n  align-items: flex-start;\n  flex-wrap: wrap;\n  width: 100%;\n  height: 100%;\n  z-index: 0;\n}\n#game-container-outer #game-container-inner #grid .cell {\n  width: 25px;\n  height: 25px;\n  box-sizing: border-box;\n  padding-top: 2px;\n  color: #393e46;\n  font-family: Architects-Daughter-400, montserrat-600, sans-serif;\n  text-align: center;\n}\n#game-container-outer #game-container-inner #grid .light-cell {\n  background-color: #415F82;\n}\n#game-container-outer #game-container-inner #grid .light-cell:hover {\n  cursor: pointer;\n  filter: brightness(120%);\n}\n#game-container-outer #game-container-inner #grid .dark-cell {\n  background-color: #465881;\n}\n#game-container-outer #game-container-inner #grid .dark-cell:hover {\n  cursor: pointer;\n  filter: brightness(95%);\n}\n#game-container-outer #game-container-inner #grid .safe-light {\n  background-color: #B7E778;\n}\n#game-container-outer #game-container-inner #grid .safe-dark {\n  background-color: #A1DD70;\n}\n#game-container-outer #game-container-inner #grid .bomb {\n  background-color: #222831;\n  padding: 0;\n}\n#game-container-outer #game-container-inner #grid .bomb .fa-bomb {\n  color: #ff9300 !important;\n  padding: 0 0 0 1px;\n  width: 90%;\n}\n#game-container-outer #game-container-inner #grid .bomb-explode {\n  background-color: #222831;\n  padding: 0;\n}\n#game-container-outer #game-container-inner #grid .bomb-explode .fa-bomb {\n  background-color: #222831;\n  padding: 0;\n  color: red;\n}\n#game-container-outer #game-container-inner #game-over {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  height: auto;\n  width: 50%;\n  transform: translate(-50%, -50%);\n  color: #dbe8d4;\n  background-color: #222831;\n  opacity: 90%;\n  text-align: center;\n}\n#game-container-outer #game-container-inner #game-over #start-again {\n  display: flex;\n  flex-direction: row;\n  justify-content: centre;\n  align-items: center;\n  background-color: #222831;\n  width: 100%;\n  height: 50px;\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #game-over #start-again button {\n  width: 100%;\n  font-size: 1.1em;\n  font-family: montserrat-600;\n  background-color: #00adb5;\n}\n#game-container-outer #game-container-inner #game-over #start-again button:hover {\n  color: #393e46;\n}\n#game-container-outer #game-container-inner .hidden {\n  visibility: hidden;\n  display: none;\n  font-size: 100px;\n}","html, body {\r\n  margin: 0;\r\n  color: $primaryColorBlack;\r\n  background-color: $primaryColorGrey;\r\n  position: relative;\r\n  height: 100%;\r\n  width: 100%;\r\n  overflow:hidden;\r\n  font-family: $fontMainLight;\r\n  font-size: 16px;\r\n}\r\n\r\nfooter {\r\n  position: absolute;\r\n  bottom: 20px;\r\n  width: 100%;\r\n  text-align: center;\r\n}\r\n\r\nnav {\r\n  width: 100%;\r\n}\r\n\r\nh1 {\r\n  font-size: 2em;\r\n}\r\n\r\nh3, h1 {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n}\r\n\r\n\r\ni {\r\n  padding: 10px;\r\n  font-size: 1.5em;\r\n}\r\n\r\nli {\r\n  list-style: none;\r\n  line-height: 1.5;\r\n  white-space: nowrap;\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n  color: $primaryColorBlack;\r\n} a:hover {\r\n    color: $primaryColorWhite;\r\n    background-color: $primaryColorGrey;\r\n\r\n}\r\n","#menu-outer {\r\n  background-color: $primaryColorOrange;\r\n  padding: 0;\r\n  date-component {\r\n    height: 50px;\r\n    background-color: $primaryColorBlack;\r\n  }\r\n  #date-container {\r\n    padding: 10px 0;\r\n    background-color: $primaryColorBlack;\r\n    color: $primaryColorOrange;\r\n    width: 100%;\r\n    height: 100%;\r\n    background-color: $primaryColorBlack;\r\n    #date, #time {\r\n    padding-left: 10px;\r\n    }\r\n  } #menu {\r\n      @include flex-row(row, space-between);\r\n      align-items: flex-start;\r\n      .menu-options {\r\n        @include flex-row(column, space-between);\r\n        background-color: $primaryColorOrange;\r\n        overflow: hidden;\r\n        flex-wrap:nowrap;\r\n        height: 100vh;\r\n      } .hide-btn {\r\n          position: absolute;\r\n          bottom: 0;\r\n          left: 0;\r\n          width: 240px;\r\n        } #menu-btn {\r\n          @include flex-row(row, space-around);\r\n          // white-space: nowrap;\r\n          // padding-right: 10px;\r\n          width: 100%;\r\n        } @keyframes menu-btn-in{\r\n          from {width: 240px;}\r\n          to {width: 40px;}\r\n            from {padding: 0 50px;}\r\n            to {padding: 0 0;}\r\n        } @keyframes menu-btn-out{\r\n          from {width: 40px;}\r\n          to {width: 240px;}\r\n          from {padding: 0 0;}\r\n          to {padding: 0 50px;}\r\n        } .menu-btn-in {\r\n            animation-name: menu-btn-in;\r\n            animation-duration: 1s;\r\n            animation-fill-mode: forwards;\r\n        } .menu-btn-out {\r\n            animation-name: menu-btn-out;\r\n            animation-duration: 1s;\r\n            animation-fill-mode: forwards;\r\n        }\r\n      }\r\n    h1 {\r\n      margin: 10px 0 5px 0;\r\n    }\r\n    ul {\r\n      margin: 0;\r\n      padding-left: 0;\r\n      width: 100%;\r\n    a {\r\n      padding-left: 15px;\r\n      display: inline-block;\r\n      width: 100%;\r\n    }\r\n  }\r\n  @keyframes menu-inn{\r\n    from {width: 180px;}\r\n    to {width: 0;}\r\n    from {padding: 0 10px;}\r\n    to {padding: 0 0;}\r\n  }\r\n  @keyframes menu-outt{\r\n    from {width: 0;}\r\n    to {width: 180px;}\r\n    from {padding: 0 0;}\r\n    to {padding: 0 10px;}\r\n  }\r\n  .menu-out {\r\n    animation-name: menu-outt;\r\n    animation-duration: 1s;\r\n    animation-fill-mode: forwards;\r\n  }\r\n  .menu-in {\r\n    animation-name: menu-inn;\r\n    animation-duration: 1s;\r\n    animation-fill-mode: forwards;\r\n  }\r\n}\r\n\r\n// nav-menu code to collapse/expand\r\n@keyframes menu-hide {\r\n  from {width: 240px;}\r\n  to {width: 40px;}\r\n}\r\n\r\n.menu-hidden {\r\n  animation-name: menu-hide;\r\n  animation-duration: 1s;\r\n  animation-fill-mode: forwards;\r\n  justify-content: flex-end;\r\n}\r\n\r\n@keyframes menu-show {\r\n  from {width: 40px;}\r\n  to {width: 240px;}\r\n}\r\n\r\n.menu-show {\r\n  animation-name: menu-show;\r\n  animation-duration: 1s;\r\n  animation-fill-mode: forwards;\r\n  justify-content: flex-end;\r\n}\r\n\r\n// Burger Menu code to interact and hide/close\r\nburger-component {\r\n  width: 40px;\r\n  height: 100vh;\r\n  background-color: $primaryColorBlack !important;\r\n} i{\r\n  color: $primaryColorWhite;\r\n  border: none;\r\n    &:hover {\r\n      cursor: pointer;\r\n      color: $primaryColorOrange;\r\n    }\r\n  }\r\n  #burger-menu {\r\n  width: auto;\r\n}\r\n\r\n@keyframes burger-show {\r\n  from {opacity: 0;}\r\n  to {opacity: 100%;}\r\n  from {width: 0;}\r\n  to {width: 40px;}\r\n}\r\n\r\n.burger-menu-show  {\r\n  animation-name: burger-show;\r\n  animation-duration: 0.2s;\r\n  @include flex-row(row, space-between);\r\n  align-items: flex-start;\r\n  height: 100vh;\r\n  background-color: $primaryColorBlack;\r\n\r\n  }\r\n\r\n@keyframes burger-hide {\r\n  from {opacity: 100%;}\r\n  to {opacity: 0;}\r\n}\r\n\r\n.burger-menu-hidden  {\r\n  animation-name: burger-hide;\r\n  animation-fill-mode: forwards;\r\n}\r\n\r\n@keyframes opacity {\r\n  from {opacity:0;}\r\n  to {opacity: 100%}\r\n}\r\n\r\ni {\r\n  animation-name: opacity;\r\n  animation-duration: 1s;\r\n}\r\n",".container {\r\n  @include flex-row(row, centre);\r\n}\r\n\r\n.game-grid {\r\n  @include flex-row(row, space-around);\r\n  position: relative;\r\n  top: -60px;\r\n  flex-wrap: wrap;\r\n  margin: auto;\r\n  width: 1200px;\r\n  .game-container {\r\n    @include flex-row(column, centre);\r\n    margin: 20px;\r\n    height: 300px;\r\n    width: 300px;\r\n    &:hover {\r\n      cursor: pointer;\r\n    }\r\n    .game-picture {\r\n      height: 300px;\r\n      width: 300px;\r\n    }\r\n  }\r\n}\r\n\r\n#cards {\r\n  background: url(\"../imgs/cards-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n}\r\n#dice {\r\n  background: url(\"../imgs/dice-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n}\r\n#minesweeper {\r\n  background: url(\"../imgs/bomb-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n}\r\n#pacman {\r\n  background: url(\"../imgs/pacman-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n}\r\n#dominoes {\r\n  background: url(\"../imgs/dominoes-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n}\r\n#rps {\r\n  background: url(\"../imgs/rps-icon.png\");\r\n  background-repeat: no-repeat;\r\n  background-size: 300px;\r\n  border-radius: 150px;\r\n}\r\n","button {\r\n  padding: 0;\r\n  right: 24px;\r\n  color: $primaryColorWhite;\r\n  background-color: $primaryColorBlack;\r\n  border: none;\r\n    &:hover {\r\n      cursor: pointer;\r\n      // background-color: $primaryColorBlack;\r\n      color: $primaryColorOrange;\r\n    }\r\n  }\r\n","\r\n\r\n#game-container-outer {\r\n  position: relative;\r\n  top: -60px;\r\n  margin: 0 auto;\r\n  width: 1200px;\r\n  align-self: center;\r\n  #title {\r\n    position: relative;\r\n    margin: 0 auto;\r\n    color: $primaryColorOrange;\r\n    font-size: 3em;\r\n    text-align: center;\r\n    letter-spacing: 0.1em;\r\n  }\r\n  .small {\r\n    width: 300px;\r\n  }\r\n  .medium {\r\n    width: 450px;\r\n  }\r\n  .large {\r\n    width: 600px;\r\n  }\r\n  #game-container-inner {\r\n    position: relative;\r\n    margin: 0 auto;\r\n    // border: 1px solid $primaryColorBlack;\r\n    #stats-row {\r\n        @include flex-row(row, space-between);\r\n        width: 100%;\r\n        height: 50px;\r\n        background-color: $primaryColorBlack;\r\n        color: $primaryColorWhite;\r\n        // border: $primaryColorBlack solid 1px;\r\n        #bombs {\r\n          @include flex-row(row, flex-start);\r\n          width: 30%;\r\n           i:hover{\r\n            color: $primaryColorWhite;\r\n            cursor: default;\r\n          }\r\n        }\r\n        #difficulty {\r\n          position: relative;\r\n          margin: 0 0 auto 10px;\r\n          padding-right: 10px;\r\n          width: 30%;\r\n          font-size: 0.8em;\r\n          background-color: $primaryColorBlack;\r\n          text-align: right;\r\n          #selected-difficulty {\r\n            margin: 11px 0 0 0;\r\n          }\r\n        }\r\n        #options{\r\n          padding: 20px 0 10px 0;\r\n          font-size: 0.9em;\r\n          h2 {\r\n            margin: auto 0;\r\n            padding-bottom: 5px;\r\n            &:hover {\r\n              background-color: $primaryColorOrange;\r\n            }\r\n          }\r\n        } .hidden {\r\n            visibility: hidden;\r\n            display: none;\r\n        }\r\n    }\r\n    #grid {\r\n      @include flex-row(row, flex-start);\r\n      align-items: flex-start;\r\n      flex-wrap: wrap;\r\n      width: 100%;\r\n      height: 100%;\r\n      // border: $primaryColorBlack solid 1px;\r\n      z-index: 0;\r\n      .cell {\r\n        width: 25px;\r\n        height: 25px;\r\n        box-sizing: border-box;\r\n        padding-top: 2px;\r\n        color: $primaryColorGrey;\r\n        font-family: $minesweeperGrid;\r\n        text-align: center;\r\n\r\n      }\r\n      .light-cell {\r\n        background-color: #415F82;\r\n        &:hover {\r\n          cursor: pointer;\r\n          filter: brightness(120%);\r\n        }\r\n      }\r\n      .dark-cell {\r\n          background-color: #465881;\r\n          &:hover {\r\n            cursor: pointer;\r\n            filter: brightness(95%);\r\n          }\r\n      }\r\n      .safe-light {\r\n        background-color: $primaryColorlightGreen;\r\n      }\r\n      .safe-dark {\r\n        background-color: $primaryColorDarkGreen;\r\n      }\r\n      .bomb {\r\n        background-color: $primaryColorBlack;\r\n        padding: 0;\r\n        .fa-bomb {\r\n          color: $primaryColorLightOrange !important;\r\n          padding: 0 0 0 1px;\r\n          width: 90%;\r\n        }\r\n      }\r\n      .bomb-explode {\r\n        background-color: $primaryColorBlack;\r\n        padding: 0;\r\n        .fa-bomb {\r\n          background-color: $primaryColorBlack;\r\n          padding: 0;\r\n          color: red;\r\n        }\r\n      }\r\n    }\r\n    #game-over {\r\n      position: absolute;\r\n      top: 50%;\r\n      left: 50%;\r\n      height: auto;\r\n      width: 50%;\r\n      transform: translate(-50%, -50%);\r\n      color: $primaryColorWhite;\r\n      background-color: $primaryColorBlack;\r\n      opacity: 90%;\r\n      text-align: center;\r\n\r\n      // .game-over-show {\r\n      //\r\n      // }\r\n      #start-again {\r\n        @include flex-row(row, centre);\r\n        background-color: $primaryColorBlack;\r\n        width: 100%;\r\n        height: 50px;\r\n        background-color: $primaryColorOrange;\r\n        button {\r\n          width: 100%;\r\n          font-size: 1.1em;\r\n          font-family: montserrat-600;\r\n          background-color: $primaryColorOrange;\r\n        } button:hover {\r\n          color: $primaryColorGrey;\r\n        }\r\n      }\r\n    } .hidden {\r\n        visibility: hidden;\r\n        display: none;\r\n        font-size: 100px;\r\n    }\r\n  }\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/fonts/architects-daughter-v11-latin-regular.woff":
/*!**************************************************************!*\
  !*** ./src/fonts/architects-daughter-v11-latin-regular.woff ***!
  \**************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "d23caff878cc5f31ce8f.woff";

/***/ }),

/***/ "./src/fonts/architects-daughter-v11-latin-regular.woff2":
/*!***************************************************************!*\
  !*** ./src/fonts/architects-daughter-v11-latin-regular.woff2 ***!
  \***************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "19380f938f389762a8be.woff2";

/***/ }),

/***/ "./src/fonts/montserrat-v18-latin-300.woff":
/*!*************************************************!*\
  !*** ./src/fonts/montserrat-v18-latin-300.woff ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "986d631a9ece69d21344.woff";

/***/ }),

/***/ "./src/fonts/montserrat-v18-latin-300.woff2":
/*!**************************************************!*\
  !*** ./src/fonts/montserrat-v18-latin-300.woff2 ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "3cd9742629b73ef2a479.woff2";

/***/ }),

/***/ "./src/fonts/montserrat-v18-latin-600.woff":
/*!*************************************************!*\
  !*** ./src/fonts/montserrat-v18-latin-600.woff ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "d7b7fa75f67f8529a264.woff";

/***/ }),

/***/ "./src/fonts/montserrat-v18-latin-600.woff2":
/*!**************************************************!*\
  !*** ./src/fonts/montserrat-v18-latin-600.woff2 ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "597e201023bc6774c535.woff2";

/***/ }),

/***/ "./src/fonts/montserrat-v18-latin-regular.woff2":
/*!******************************************************!*\
  !*** ./src/fonts/montserrat-v18-latin-regular.woff2 ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "b07bcc994632839adaff.woff2";

/***/ }),

/***/ "./src/imgs/bomb-icon.png":
/*!********************************!*\
  !*** ./src/imgs/bomb-icon.png ***!
  \********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "6343e44469c6a26b53bc.png";

/***/ }),

/***/ "./src/imgs/cards-icon.png":
/*!*********************************!*\
  !*** ./src/imgs/cards-icon.png ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "a6246010a637bd780cce.png";

/***/ }),

/***/ "./src/imgs/dice-icon.png":
/*!********************************!*\
  !*** ./src/imgs/dice-icon.png ***!
  \********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "0cbf86c92783a30ecee1.png";

/***/ }),

/***/ "./src/imgs/dominoes-icon.png":
/*!************************************!*\
  !*** ./src/imgs/dominoes-icon.png ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "c75f833917eb2aa9495e.png";

/***/ }),

/***/ "./src/imgs/pacman-icon.png":
/*!**********************************!*\
  !*** ./src/imgs/pacman-icon.png ***!
  \**********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "1d0db0fb69c505925896.png";

/***/ }),

/***/ "./src/imgs/rps-icon.png":
/*!*******************************!*\
  !*** ./src/imgs/rps-icon.png ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/* harmony import */ var _menu_component_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./menu-component.js */ "./src/menu-component.js");
/* harmony import */ var _minesweeper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./minesweeper.js */ "./src/minesweeper.js");
