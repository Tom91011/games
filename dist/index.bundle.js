...
function populateGrid() {
  ...
  var resetGame = function resetGame() {
    ...
    function clickBomb(event) {
      ...
      var cellStatus = GetCellStatus(bombCell);
      highlightBomb(bombCell, cellStatus); // console.log(bombCell);
...
var GetCellStatus = function GetCellStatus(cell) {
...
var getCurrentDifficulty = function getCurrentDifficulty() {// if()
};
