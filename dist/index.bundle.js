...
function populateGrid() {
  ...
  var selectedDifficultyEl = document.getElementById("selected-difficulty");
  ...
  function checkIndex(event) {
    ...
    layMines(findCellType(getCellCategories(), clickedCell), clickedCell); // highlightMines()
...
var highlightMines = function highlightMines() {
  ...
  minesArray.forEach(function (element) {
    gridCellArray[element].classList.add("test"); // classifyCell(element, "mine")
